...
(function(){
	window.Product_Management = window.Product_Management?window.Product_Management:{};
	...
	myPopup.prototype.setPos=function(){
		...
		} else if(_height>=_body){
			//console.log("_height",_height,'$(window).height()',$(window).height())
			_this.elem.css("position","absolute");
			_top=0;
		}else {
	...
	/*点击添加样式*/
	toClickAddClass= function(obj,sClass){
